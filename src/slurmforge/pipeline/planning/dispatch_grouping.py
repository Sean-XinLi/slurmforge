"""Array-group signature computation.

Lives in the planning layer so validate, dry-run, gpu_budget planner,
and materialization all consume the same grouping primitive.
"""
...
SLURM_RESOURCE_GROUPING_KEYS: tuple[str, ...] = (
    "partition",
    "account",
    "qos",
    "time_limit",
...
_RESOURCE_BUCKET_KEYS: tuple[str, ...] = (
    "nodes",
    "gpus_per_node",
    "cpus_per_task",
    "mem",
...
RUNTIME_ENV_GROUPING_KEYS: tuple[str, ...] = (
    "modules",
    "conda_activate",
    "venv_activate",
    "extra_env",
