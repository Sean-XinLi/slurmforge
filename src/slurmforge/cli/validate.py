...
def render_validate(
    *,
    ...
    spec = load_experiment_spec(
        ...
        else Path(project_root_override),
    )
...
def add_subparser(
    ...
    parser = subparsers.add_parser(
        "validate", help="Validate a stage-batch experiment spec without emitting files"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        dest="project_root",
        default=None,
        help="Override project root for relative paths",
    )
