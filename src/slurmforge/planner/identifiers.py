...
def batch_id(
    stage_name: str, runs: tuple[RunDefinition, ...], source_ref: str, spec_digest: str
) -> str:
    payload = {
...
def train_eval_pipeline_id(
    spec: ExperimentSpec, runs: tuple[RunDefinition, ...], stage_order: tuple[str, ...]
) -> str:
    payload = {
