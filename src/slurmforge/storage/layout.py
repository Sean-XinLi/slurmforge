"""Layout writers for stage_batch / train-eval pipeline roots.
...
from ..lineage import build_train_eval_pipeline_lineage, build_stage_batch_lineage, write_lineage_index
from ..plans import (
