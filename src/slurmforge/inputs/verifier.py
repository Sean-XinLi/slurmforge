...
from ..io import SchemaVersion, content_digest, file_digest, to_jsonable, utc_now, write_json
from ..schema import (
    InputBinding,
...
def verify_stage_instance_inputs(
    ...
    *,
    ...
    now = utc_now()
    records = tuple(_record_for_binding(binding, phase=phase, now=now) for binding in bindings)
