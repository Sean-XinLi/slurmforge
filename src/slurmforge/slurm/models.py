...
SLURM_FAILURE_STATES = {"FAILED", "NODE_FAIL", "OUT_OF_MEMORY", "TIMEOUT", "BOOT_FAIL", "DEADLINE"}
...
SLURM_TERMINAL_STATES = SLURM_SUCCESS_STATES | SLURM_FAILURE_STATES | SLURM_CANCELLED_STATES
